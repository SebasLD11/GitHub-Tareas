...
public class TA02Password {
    ...
    // Constructores
    public TA02Password(int longitud, String contraseña) {
		super();
		this.longitud = longitud;
		this.contraseña = contraseña;
	}
    
    public TA02Password(String contraseña, int longitud) {
		super();
		this.longitud = 0;
		this.contraseña = "";
	}
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "CONTRASEÑA PERSONALIZADA\n" + contraseñaPersonalizada);
    }
}
