...
public class EjGrupal3 {
		...
		public static void main(String[] args) {
			...
			while (true) {
				...
				switch (opcion) {
	            case "1":
	                 añadirArticulo(productosMap, scanner);
	                System.out.println("1");

	                break;
				case "2":
					consultarStock(productosMap, scanner);
		...
		private static void consultarStock(Map<String, Map<String, Object>> productosMap, Scanner scanner) {
			// TODO Auto-generated method stub			
		}
		private static void añadirArticulo(Map<String, Map<String, Object>> productosMap, Scanner scanner) {
			// TODO Auto-generated method stub
		}
		...
		private static int consultarCantidadTotal(Map<String, Map<String, Object>> productosMap) {
			int cantidadTotal = 0;

			for (Map<String, Object> datosProductos : productosMap.values()) {
				if (datosProductos.containsKey("cantidad")) {
            cantidadTotal += (int) datosProductos.get("cantidad");
        }
    }
